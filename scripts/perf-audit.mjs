...
const ROUTES = [
  ...
  { n: "article:espacio-libre", p: "/proyectos/espacio-libre-de-dinero" },
  { n: "article:elegir-criterio", p: "/proyectos/elegir-con-criterio" },
  { n: "opinion", p: "/opinion" },
  { n: "article:critica-tecnologica", p: "/opinion/critica-tecnologica" },
  { n: "article:manifiesto", p: "/opinion/manifiesto-eligete-a-ti" },
  { n: "article:soberania-digital", p: "/opinion/soberania-digital" },
  { n: "article:escape-feudo", p: "/opinion/escape-del-feudo-algoritmico" },
