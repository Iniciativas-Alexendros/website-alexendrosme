...
const ROUTES = [
  { n: "home", p: "/" },
  { n: "ideas", p: "/ideas" },
  { n: "article:critica-tecnologica", p: "/ideas/critica-tecnologica" },
  { n: "article:manifiesto", p: "/ideas/manifiesto-eligete-a-ti" },
  { n: "article:soberania-digital", p: "/ideas/soberania-digital" },
  { n: "acciones", p: "/acciones" },
  { n: "article:escape-feudo", p: "/acciones/escape-del-feudo-algoritmico" },
  { n: "article:protocolos", p: "/acciones/protocolos-vs-plataformas" },
  { n: "now", p: "/now" },
  { n: "tags", p: "/tags" },
