      ...
      assertMatrix: [
        {
          ...
          assertions: {
            ...
            "resource-summary:document:size": ["warn", { maxNumericValue: 15000 }],
            "resource-summary:script:size": ["warn", { maxNumericValue: 100000 }],
            "resource-summary:stylesheet:size": ["warn", { maxNumericValue: 30000 }],
            "resource-summary:font:size": ["warn", { maxNumericValue: 80000 }],
