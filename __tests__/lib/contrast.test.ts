...
const DARK: TokenMap = resolveAll({
  ...
  "--ax-text-tertiary": "oklch(0.75 0.01 310)",
...
const LIGHT: TokenMap = resolveAll({
  "--ax-surface-0": "oklch(0.985 0.004 85)",
  "--ax-surface-100": "oklch(0.94 0.007 85)",
  "--ax-surface-200": "oklch(0.9 0.008 85)",
  "--ax-surface-300": "oklch(0.86 0.009 85)",
  "--ax-surface-400": "oklch(0.8 0.01 85)",
  "--ax-surface-500": "oklch(0.74 0.011 85)",
  "--ax-surface-600": "oklch(0.66 0.012 85)",
  "--ax-surface-700": "oklch(0.58 0.013 85)",
  "--ax-surface-800": "oklch(0.5 0.014 85)",
  "--ax-surface-900": "oklch(0.42 0.015 85)",
  "--ax-accent": "oklch(0.52 0.16 85)",
  "--ax-accent-dim": "oklch(0.44 0.14 85)",
  "--ax-accent-bright": "oklch(0.44 0.17 85)",
  "--ax-accent-fg": "oklch(1 0 0)",
  "--ax-text-primary": "oklch(0.18 0.01 315)",
  "--ax-text-secondary": "oklch(0.32 0.01 315)",
  "--ax-text-tertiary": "oklch(0.4 0.01 315)",
  "--ax-text-disabled": "oklch(0.62 0.012 315)",
  "--ax-text-inverse": "oklch(0.97 0.004 85)",
  // Brand aliases
  "--ax-brand-primary": "var(--ax-accent)",
  "--ax-brand-primary-fg": "var(--ax-accent-fg)",
  "--ax-brand-accent": "var(--ax-accent-dim)",
